...
build:
    ...
    just get-version | xargs -I {} docker build -t ${REGISTRY}/gh-star-sorter:{} .
    docker tag ${REGISTRY}/gh-star-sorter:$(just get-version) ${REGISTRY}/gh-star-sorter:latest

# Push Docker image with version tag
build-and-push:
    docker context use default
    just build
    just get-version | xargs -I {} docker push ${REGISTRY}/gh-star-sorter:{}
    docker push ${REGISTRY}/gh-star-sorter:latest
